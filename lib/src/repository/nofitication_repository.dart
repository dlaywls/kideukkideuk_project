...
class NotificationRepository {
  ...
  Future<void> addNotification({
    ...
    DocumentReference documentReference = await _notification.add(
        {'receiver_id': receiverId, 'contents': contents, "board_id": boardId});
  }
  ...
  Future<List<Notification>> getNotificationsByReceiverId(
    ...
    try {
      ...
      QuerySnapshot querySnapshot =
          await _notification.where('receiver_id', isEqualTo: receiverId).get();
